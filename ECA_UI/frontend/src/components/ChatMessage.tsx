...
export default function ChatMessage({ message }: ChatMessageProps) {
  ...
  if (!isUser) {
    ...
    return (
      <div className="px-5 py-3 animate-message-in w-full max-w-full">
  ...
  return (
    <div className="flex gap-3 px-4 py-2 animate-message-in flex-row-reverse w-full max-w-full">
      {/* Avatar */}
      ...
      {/* Bubble */}
      <div className="max-w-[80%] min-w-0 rounded-2xl px-4 py-2.5 text-sm leading-relaxed bg-primary text-primary-foreground rounded-tr-md">
        <p className="whitespace-pre-wrap break-words">{message.content}</p>
